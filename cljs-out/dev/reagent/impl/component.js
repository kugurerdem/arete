...
var temp__5722__auto__ = p.argv;
if((temp__5722__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__10762 = p.children;
return reagent.impl.component.global$module$react.Children.toArray(G__10762);
})());
} else {
var v = temp__5722__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__10764 = c;
var G__10764__$1 = (((G__10764 == null))?null:G__10764.prototype);
if((G__10764__$1 == null)){
return null;
} else {
return G__10764__$1.render;
}
})() == null)))));
});
...
while (G__10768__i < G__10768__a.length) {G__10768__a[G__10768__i] = arguments[G__10768__i + 0]; ++G__10768__i;}
  args = new cljs.core.IndexedSeq(G__10768__a,0,null);
} 
...
var or__4253__auto__ = (function (){var G__10772 = c;
var G__10772__$1 = (((G__10772 == null))?null:G__10772.constructor);
if((G__10772__$1 == null)){
return null;
} else {
return G__10772__$1.displayName;
}
})();
...
var G__10773 = c;
var G__10773__$1 = (((G__10773 == null))?null:G__10773.constructor);
if((G__10773__$1 == null)){
return null;
} else {
return G__10773__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__10774 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__10775 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__10775);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__10774);
}});
...
var c = this;
var G__10778_10780 = reagent.impl.component.goog$module$goog$object.get.call(null,c,"cljsRatom");
if((G__10778_10780 == null)){
} else {
reagent.ratom.dispose_BANG_(G__10778_10780);
}
...
var renders_10781 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender], null));
var render_fun_10782 = cljs.core.first(cljs.core.vals(renders_10781));
...
if((cljs.core.count(renders_10781) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_10781))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_10782)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_10782], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__10783 = o;
var G__10784_10787 = G__10783;
var G__10785_10788 = cljs.core.name(k);
var G__10786_10789 = v;
reagent.impl.component.goog$module$goog$object.set.call(null,G__10784_10787,G__10785_10788,G__10786_10789);
...
var G__10790_10793 = cmp.prototype;
var G__10791_10794 = reagent.impl.component.global$module$react.Component.prototype;
var G__10792_10795 = methods$;
reagent.impl.component.goog$module$goog$object.extend.call(null,G__10790_10793,G__10791_10794,G__10792_10795);
...
var G__10796 = c;
var G__10797 = reagent.impl.protocols.get_id(compiler);
return reagent.impl.component.goog$module$goog$object.get.call(null,G__10796,G__10797);
});
reagent.impl.component.cache_react_class = (function reagent$impl$component$cache_react_class(compiler,c,constructor$){
var G__10798_10801 = c;
var G__10799_10802 = reagent.impl.protocols.get_id(compiler);
var G__10800_10803 = constructor$;
reagent.impl.component.goog$module$goog$object.set.call(null,G__10798_10801,G__10799_10802,G__10800_10803);
...
var _STAR_current_component_STAR__orig_val__10809 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__10810 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__10810);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__10809);
}});
...
var vec__10811 = reagent.impl.component.global$module$react.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10811,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10811,(1),null);
...
var G__10814_10817 = (function reagent$impl$component$functional_render_$_mount(){
return (function reagent$impl$component$functional_render_$_mount_$_unmount(){
var G__10816 = reagent.impl.component.goog$module$goog$object.get.call(null,reagent_state,"cljsRatom");
if((G__10816 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__10816);
}
});
});
var G__10815_10818 = [];
reagent.impl.component.global$module$react.useEffect(G__10814_10817,G__10815_10818);
