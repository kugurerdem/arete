...
var G__21587 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__21587,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__21587;
}
}));
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq21589){
var G__21590 = cljs.core.first.call(null,seq21589);
var seq21589__$1 = cljs.core.next.call(null,seq21589);
var G__21591 = cljs.core.first.call(null,seq21589__$1);
var seq21589__$2 = cljs.core.next.call(null,seq21589__$1);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21590,G__21591,seq21589__$2);
}));
...
var map__21596 = m;
var map__21596__$1 = cljs.core.__destructure_map.call(null,map__21596);
var file = cljs.core.get.call(null,map__21596__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__21596__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__21596__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,(function (p1__21595_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__21595_SHARP_));
...
var temp__5720__auto___21597 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___21597)){
var message_21598 = temp__5720__auto___21597;
cljs.core.println.call(null,message_21598);
} else {
}
...
var temp__5720__auto___21599 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___21599)){
var message_21600 = temp__5720__auto___21599;
cljs.core.println.call(null,message_21600);
} else {
}
...
var output_dir__$1 = (function (){var G__21601 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__21601,"/"].join('');
} else {
return G__21601;
}
})();
...
var G__21602 = exception.stack;
var G__21602__$1 = (((G__21602 == null))?null:clojure.string.split_lines.call(null,G__21602));
var G__21602__$2 = (((G__21602__$1 == null))?null:cljs.core.get.call(null,G__21602__$1,depth));
if((G__21602__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__21602__$2);
}
} else {
...
var vec__21603 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__21603,(0),null);
var column = cljs.core.nth.call(null,vec__21603,(1),null);
var vec__21606 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__21606,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__21606,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__21606,(2),null);
...
var m__$1 = (function (){var G__21609 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__21613 = (function (){var G__21612 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__21612);
} else {
return G__21612;
}
})();
...
return cljs.core.vary_meta.call(null,G__21614,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__21618 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__21618,(0),null);
var types = vec__21618;
...
return cljs.core.map.call(null,(function (p__21621){
var vec__21622 = p__21621;
var ns = cljs.core.nth.call(null,vec__21622,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__21622,(1),null);
return (function (){
...
var G__21625 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
var seq__21626 = cljs.core.seq.call(null,vars__$1);
var chunk__21627 = null;
var count__21628 = (0);
var i__21629 = (0);
while(true){
if((i__21629 < count__21628)){
var v = cljs.core._nth.call(null,chunk__21627,i__21629);
var temp__5720__auto___21631 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___21631)){
var t_21632 = temp__5720__auto___21631;
each_fixture_fn.call(null,((function (seq__21626,chunk__21627,count__21628,i__21629,t_21632,temp__5720__auto___21631,v,each_fixture_fn,G__21625,G__21625__$1,env,once_fixtures,each_fixtures,vec__21622,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_21632)));
});})(seq__21626,chunk__21627,count__21628,i__21629,t_21632,temp__5720__auto___21631,v,each_fixture_fn,G__21625,G__21625__$1,env,once_fixtures,each_fixtures,vec__21622,ns,vars__$1))
);
} else {
}


var G__21633 = seq__21626;
var G__21634 = chunk__21627;
var G__21635 = count__21628;
var G__21636 = (i__21629 + (1));
seq__21626 = G__21633;
chunk__21627 = G__21634;
count__21628 = G__21635;
i__21629 = G__21636;
continue;
} else {
var temp__5720__auto__ = cljs.core.seq.call(null,seq__21626);
if(temp__5720__auto__){
var seq__21626__$1 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__21626__$1)){
var c__4679__auto__ = cljs.core.chunk_first.call(null,seq__21626__$1);
var G__21637 = cljs.core.chunk_rest.call(null,seq__21626__$1);
var G__21638 = c__4679__auto__;
var G__21639 = cljs.core.count.call(null,c__4679__auto__);
var G__21640 = (0);
seq__21626 = G__21637;
chunk__21627 = G__21638;
count__21628 = G__21639;
i__21629 = G__21640;
continue;
} else {
var v = cljs.core.first.call(null,seq__21626__$1);
var temp__5720__auto___21641__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___21641__$1)){
var t_21642 = temp__5720__auto___21641__$1;
each_fixture_fn.call(null,((function (seq__21626,chunk__21627,count__21628,i__21629,t_21642,temp__5720__auto___21641__$1,v,seq__21626__$1,temp__5720__auto__,each_fixture_fn,G__21625,G__21625__$1,env,once_fixtures,each_fixtures,vec__21622,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_21642)));
});})(seq__21626,chunk__21627,count__21628,i__21629,t_21642,temp__5720__auto___21641__$1,v,seq__21626__$1,temp__5720__auto__,each_fixture_fn,G__21625,G__21625__$1,env,once_fixtures,each_fixtures,vec__21622,ns,vars__$1))
);
} else {
}


var G__21643 = cljs.core.next.call(null,seq__21626__$1);
var G__21644 = null;
var G__21645 = (0);
var G__21646 = (0);
seq__21626 = G__21643;
chunk__21627 = G__21644;
count__21628 = G__21645;
i__21629 = G__21646;
continue;
}
} else {
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__21625__$1)].join('')));
