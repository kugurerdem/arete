...
var G__10457 = devtools.prefs.pref.call(null,v);
v = G__10457;
continue;
} else {
return v;
...
}catch (e10458){var _e__9974__auto__ = e10458;
return false;
}})();
...
}catch (e10460){var _e__9974__auto__ = e10460;
return false;
}})();
...
}catch (e10462){var _e__9974__auto__ = e10462;
return false;
}}
}
});
...
var vec__10464 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__10464,(0),null);
var name = cljs.core.nth.call(null,vec__10464,(1),null);
...
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__10467_SHARP_);
}),template);
});
