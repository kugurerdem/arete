...
var G__23119 = devtools.prefs.pref.call(null,v);
v = G__23119;
continue;
} else {
return v;
...
}catch (e23120){var _e__22636__auto__ = e23120;
return false;
}})();
...
}catch (e23122){var _e__22636__auto__ = e23122;
return false;
}})();
...
}catch (e23124){var _e__22636__auto__ = e23124;
return false;
}}
}
});
...
var vec__23126 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__23126,(0),null);
var name = cljs.core.nth.call(null,vec__23126,(1),null);
...
return cljs.core.some.call(null,(function (p1__23129_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__23129_SHARP_);
}),template);
});
