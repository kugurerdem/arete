...
var o22809 = temp__5718__auto__;
var temp__5718__auto____$1 = (o22809["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o22810 = temp__5718__auto____$1;
return (o22810["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__22629__auto__ = f;
return (o__22629__auto__["toString"]).call(o__22629__auto__);
} else {
return "";
}
}catch (e22811){var _ = e22811;
return "";
}});
...
try{var o__22629__auto___22813 = t;
(o__22629__auto___22813["cljs$lang$ctorPrWriter"]).call(o__22629__auto___22813,t,writer);
}catch (e22812){var __22814 = e22812;
}
...
var char_code = (function (){var o__22629__auto__ = (new String(char$));
return (o__22629__auto__["charCodeAt"]).call(o__22629__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__22629__auto__ = String;
return (o__22629__auto__["fromCharCode"]).call(o__22629__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__22815 = num_code;
switch (G__22815) {
case (1):
return (185);
...
var o__22629__auto__ = String;
return (o__22629__auto__["fromCharCode"]).call(o__22629__auto__,superscript_code);
});
/**
...
}catch (e22817){var _e__22636__auto__ = e22817;
return false;
}})())){
...
var vec__22818 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__22818,(0),null);
...
var len__4864__auto___22827 = arguments.length;
var i__4865__auto___22828 = (0);
while(true){
if((i__4865__auto___22828 < len__4864__auto___22827)){
args__4870__auto__.push((arguments[i__4865__auto___22828]));

var G__22829 = (i__4865__auto___22828 + (1));
i__4865__auto___22828 = G__22829;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__22823){
var vec__22824 = p__22823;
var ns_detector = cljs.core.nth.call(null,vec__22824,(0),null);
...
var G__22830 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__22831 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__22830;
remaining_tokens = G__22831;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq22821){
var G__22822 = cljs.core.first.call(null,seq22821);
var seq22821__$1 = cljs.core.next.call(null,seq22821);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22822,seq22821__$1);
}));
...
var vec__22835 = cljs.core.split_with.call(null,(function (p1__22834_SHARP_){
return cljs.core.not_EQ_.call(null,p1__22834_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__22835,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__22835,(1),null);
...
var vec__22841 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__22841,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__22841,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__22844 = cljs.core.rest.call(null,remaining_tokens);
var G__22845 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__22844;
name_tokens = G__22845;
continue;
} else {
...
var vec__22848 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__22848,(0),null);
var arity = cljs.core.nth.call(null,vec__22848,(1),null);
var vec__22851 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__22851,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__22851,(1),null);
var vec__22854 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__22854,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__22854,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__22854,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__22854,(3),null);
...
var vec__22860 = result;
var munged_ns = cljs.core.nth.call(null,vec__22860,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__22860,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__22860,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__22860,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__22860,(4),null);
var arity = cljs.core.nth.call(null,vec__22860,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__22864 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__22864,(0),null);
var args = cljs.core.nth.call(null,vec__22864,(1),null);
var vec__22867 = devtools.munging.break_and_demunge_name.call(null,munged_name);
...
var G__22870 = (arity + (1));
var G__22871 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__22872){
var vec__22873 = p__22872;
var arity = cljs.core.nth.call(null,vec__22873,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__22873,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__22876_SHARP_){
return cljs.core.get.call(null,arities,p1__22876_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__22877_SHARP_){
return cljs.core.drop.call(null,(2),p1__22877_SHARP_);
}),sorted_infos);
...
var args__4870__auto__ = [];
var len__4864__auto___22884 = arguments.length;
var i__4865__auto___22885 = (0);
while(true){
if((i__4865__auto___22885 < len__4864__auto___22884)){
args__4870__auto__.push((arguments[i__4865__auto___22885]));

var G__22886 = (i__4865__auto___22885 + (1));
i__4865__auto___22885 = G__22886;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__22880){
var vec__22881 = p__22880;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__22881,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq22878){
var G__22879 = cljs.core.first.call(null,seq22878);
var seq22878__$1 = cljs.core.next.call(null,seq22878);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22879,seq22878__$1);
}));
...
var map__22889 = options;
var map__22889__$1 = cljs.core.__destructure_map.call(null,map__22889);
var include_ns_QMARK_ = cljs.core.get.call(null,map__22889__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__22889__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__22889__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__22889__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__22890 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__22890,(0),null);
var fn_name = cljs.core.nth.call(null,vec__22890,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__22890,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__22890,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__22890,(4),null);
var arity = cljs.core.nth.call(null,vec__22890,(5),null);
...
var o__22629__auto__ = f;
return (o__22629__auto__["getBasis"]).call(o__22629__auto__);
});
/**
...
}catch (e22893){var _e__22636__auto__ = e22893;
...
var G__22894 = (obj[cljs.core.first.call(null,path)]);
var G__22895 = cljs.core.rest.call(null,path);
obj = G__22894;
path = G__22895;
continue;
} else {
...
var _STAR_ = (function (accum,p__22896){
var vec__22897 = p__22896;
var bit = cljs.core.nth.call(null,vec__22897,(0),null);
var protocol = cljs.core.nth.call(null,vec__22897,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__22900){
var vec__22901 = p__22900;
var ns = cljs.core.nth.call(null,vec__22901,(0),null);
var name = cljs.core.nth.call(null,vec__22901,(1),null);
var selector = cljs.core.nth.call(null,vec__22901,(2),null);
...
var post_process = (function (p__22905){
var vec__22906 = p__22905;
var munged_name = cljs.core.nth.call(null,vec__22906,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__22906,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__22904_SHARP_){
return (obj[cljs.core.first.call(null,p1__22904_SHARP_)]);
}),sorted_matches);
