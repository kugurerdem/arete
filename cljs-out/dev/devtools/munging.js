...
var o10147 = temp__5718__auto__;
var temp__5718__auto____$1 = (o10147["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o10148 = temp__5718__auto____$1;
return (o10148["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__9967__auto__ = f;
return (o__9967__auto__["toString"]).call(o__9967__auto__);
} else {
return "";
}
}catch (e10149){var _ = e10149;
return "";
}});
...
try{var o__9967__auto___10151 = t;
(o__9967__auto___10151["cljs$lang$ctorPrWriter"]).call(o__9967__auto___10151,t,writer);
}catch (e10150){var __10152 = e10150;
}
...
var char_code = (function (){var o__9967__auto__ = (new String(char$));
return (o__9967__auto__["charCodeAt"]).call(o__9967__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__9967__auto__ = String;
return (o__9967__auto__["fromCharCode"]).call(o__9967__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__10153 = num_code;
switch (G__10153) {
case (1):
return (185);
...
var o__9967__auto__ = String;
return (o__9967__auto__["fromCharCode"]).call(o__9967__auto__,superscript_code);
});
/**
...
}catch (e10155){var _e__9974__auto__ = e10155;
return false;
}})())){
...
var vec__10156 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__10156,(0),null);
...
var len__4864__auto___10165 = arguments.length;
var i__4865__auto___10166 = (0);
while(true){
if((i__4865__auto___10166 < len__4864__auto___10165)){
args__4870__auto__.push((arguments[i__4865__auto___10166]));

var G__10167 = (i__4865__auto___10166 + (1));
i__4865__auto___10166 = G__10167;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__10161){
var vec__10162 = p__10161;
var ns_detector = cljs.core.nth.call(null,vec__10162,(0),null);
...
var G__10168 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__10169 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__10168;
remaining_tokens = G__10169;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq10159){
var G__10160 = cljs.core.first.call(null,seq10159);
var seq10159__$1 = cljs.core.next.call(null,seq10159);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10160,seq10159__$1);
}));
...
var vec__10173 = cljs.core.split_with.call(null,(function (p1__10172_SHARP_){
return cljs.core.not_EQ_.call(null,p1__10172_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__10173,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__10173,(1),null);
...
var vec__10179 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__10179,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__10179,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__10182 = cljs.core.rest.call(null,remaining_tokens);
var G__10183 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__10182;
name_tokens = G__10183;
continue;
} else {
...
var vec__10186 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__10186,(0),null);
var arity = cljs.core.nth.call(null,vec__10186,(1),null);
var vec__10189 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__10189,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__10189,(1),null);
var vec__10192 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__10192,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__10192,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__10192,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__10192,(3),null);
...
var vec__10198 = result;
var munged_ns = cljs.core.nth.call(null,vec__10198,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__10198,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__10198,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__10198,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__10198,(4),null);
var arity = cljs.core.nth.call(null,vec__10198,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__10202 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__10202,(0),null);
var args = cljs.core.nth.call(null,vec__10202,(1),null);
var vec__10205 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__10205,(0),null);
var name = cljs.core.nth.call(null,vec__10205,(1),null);
...
var G__10208 = (arity + (1));
var G__10209 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__10210){
var vec__10211 = p__10210;
var arity = cljs.core.nth.call(null,vec__10211,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__10211,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__10214_SHARP_){
return cljs.core.get.call(null,arities,p1__10214_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__10215_SHARP_){
return cljs.core.drop.call(null,(2),p1__10215_SHARP_);
}),sorted_infos);
...
var args__4870__auto__ = [];
var len__4864__auto___10222 = arguments.length;
var i__4865__auto___10223 = (0);
while(true){
if((i__4865__auto___10223 < len__4864__auto___10222)){
args__4870__auto__.push((arguments[i__4865__auto___10223]));

var G__10224 = (i__4865__auto___10223 + (1));
i__4865__auto___10223 = G__10224;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__10218){
var vec__10219 = p__10218;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__10219,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq10216){
var G__10217 = cljs.core.first.call(null,seq10216);
var seq10216__$1 = cljs.core.next.call(null,seq10216);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10217,seq10216__$1);
}));
...
var map__10227 = options;
var map__10227__$1 = cljs.core.__destructure_map.call(null,map__10227);
var include_ns_QMARK_ = cljs.core.get.call(null,map__10227__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__10227__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__10227__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__10227__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__10228 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__10228,(0),null);
var fn_name = cljs.core.nth.call(null,vec__10228,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__10228,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__10228,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__10228,(4),null);
...
var o__9967__auto__ = f;
return (o__9967__auto__["getBasis"]).call(o__9967__auto__);
});
/**
...
}catch (e10231){var _e__9974__auto__ = e10231;
...
var G__10232 = (obj[cljs.core.first.call(null,path)]);
var G__10233 = cljs.core.rest.call(null,path);
obj = G__10232;
path = G__10233;
continue;
} else {
...
var _STAR_ = (function (accum,p__10234){
var vec__10235 = p__10234;
var bit = cljs.core.nth.call(null,vec__10235,(0),null);
var protocol = cljs.core.nth.call(null,vec__10235,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__10238){
var vec__10239 = p__10238;
var ns = cljs.core.nth.call(null,vec__10239,(0),null);
var name = cljs.core.nth.call(null,vec__10239,(1),null);
var selector = cljs.core.nth.call(null,vec__10239,(2),null);
...
var post_process = (function (p__10243){
var vec__10244 = p__10243;
var munged_name = cljs.core.nth.call(null,vec__10244,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__10244,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__10242_SHARP_){
return (obj[cljs.core.first.call(null,p1__10242_SHARP_)]);
}),sorted_matches);
