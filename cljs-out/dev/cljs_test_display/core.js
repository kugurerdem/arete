...
var node = cljs_test_display.core.n.call(null,new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),"cljs-test-display-style"], null),style_string_21710);
...
/** @this {Function} */
(cljs_test_display.core.n.cljs$lang$applyTo = (function (seq21711){
...
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21712,G__21713,seq21711__$2);
}));
...
var vec__21717 = ((clojure.string.starts_with_QMARK_.call(null,cljs.core.first.call(null,classes),"#"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,cljs.core.first.call(null,classes),(1)),cljs.core.rest.call(null,classes)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,classes], null));
var id = cljs.core.nth.call(null,vec__21717,(0),null);
var classes__$1 = cljs.core.nth.call(null,vec__21717,(1),null);
var G__21720 = cljs.core.PersistentArrayMap.EMPTY;
var G__21720__$1 = (cljs.core.truth_(id)?cljs.core.assoc.call(null,G__21720,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__21720);
if(cljs.core.truth_(cljs.core.not_empty.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__21720__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",classes__$1));
} else {
return G__21720__$1;
}
} else {
...
return (function() { 
var G__21724__delegate = function (klass,contents){
var vec__21721 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons.call(null,klass,contents)], null));
var klass__$1 = cljs.core.nth.call(null,vec__21721,(0),null);
var contents__$1 = cljs.core.nth.call(null,vec__21721,(1),null);
...
var G__21724 = function (klass,var_args){
var contents = null;
if (arguments.length > 1) {
var G__21725__i = 0, G__21725__a = new Array(arguments.length -  1);
while (G__21725__i < G__21725__a.length) {G__21725__a[G__21725__i] = arguments[G__21725__i + 1]; ++G__21725__i;}
  contents = new cljs.core.IndexedSeq(G__21725__a,0,null);
} 
return G__21724__delegate.call(this,klass,contents);};
G__21724.cljs$lang$maxFixedArity = 1;
G__21724.cljs$lang$applyTo = (function (arglist__21726){
var klass = cljs.core.first(arglist__21726);
var contents = cljs.core.rest(arglist__21726);
return G__21724__delegate(klass,contents);
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__21730){
var map__21731 = p__21730;
var map__21731__$1 = cljs.core.__destructure_map.call(null,map__21731);
var ns = cljs.core.get.call(null,map__21731__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var file = cljs.core.get.call(null,map__21731__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__21732){
var map__21733 = p__21732;
var map__21733__$1 = cljs.core.__destructure_map.call(null,map__21733);
var actual = cljs.core.get.call(null,map__21733__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.call(null,map__21733__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__21734){
var map__21735 = p__21734;
var map__21735__$1 = cljs.core.__destructure_map.call(null,map__21735);
var expected = cljs.core.get.call(null,map__21735__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.call(null,map__21735__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
cljs.core.swap_BANG_.call(null,cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__21736_SHARP_){
return cljs.core.cons.call(null,new_current_node,p1__21736_SHARP_);
}));
...
var curr_node = cljs_test_display.core.current_node.call(null);
var map__21738 = cljs_test_display.core.current_var_info.call(null);
var map__21738__$1 = cljs.core.__destructure_map.call(null,map__21738);
var info = map__21738__$1;
var name = cljs.core.get.call(null,map__21738__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var line = cljs.core.get.call(null,map__21738__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__21738__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs.core.swap_BANG_.call(null,cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__21737_SHARP_){
return cljs.core.cons.call(null,node,p1__21737_SHARP_);
}));

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__21739){
var map__21740 = p__21739;
var map__21740__$1 = cljs.core.__destructure_map.call(null,map__21740);
var m = map__21740__$1;
var fail = cljs.core.get.call(null,map__21740__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.call(null,map__21740__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.call(null,map__21740__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.call(null,map__21740__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
var temp__5720__auto___21741 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___21741)){
var message_21742 = temp__5720__auto___21741;
cljs.core.println.call(null,message_21742);
} else {
}
...
var temp__5720__auto___21743 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___21743)){
var message_21744 = temp__5720__auto___21743;
cljs.core.println.call(null,message_21744);
} else {
}
