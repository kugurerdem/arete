...
return html_coll.item(p1__21657_SHARP_);
...
return cljs.core.some.call(null,(function (p1__21658_SHARP_){
return cljs.core._EQ_.call(null,"icon",p1__21658_SHARP_);
...
var ctx_21659 = cvs.getContext("2d");
(ctx_21659.fillStyle = color);

ctx_21659.fillRect((0),(0),size,size);
